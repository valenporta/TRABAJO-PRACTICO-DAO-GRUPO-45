...
class HistoriaClinicaView(tk.Frame):
    ...
    def _crear_widgets(self, parent_frame):
        ...
        # -----------------------------------------------------------------
        # 2. TABLA DE HISTORIA CLÍNICA (RESUMEN)
        # -----------------------------------------------------------------
        ...
        self.tabla_historia = ttk.Treeview(historia_frame, columns=columnas_historia, show="headings", height=10)
        ...
        # -----------------------------------------------------------------
        # 3. DETALLE DE LA ATENCIÓN (Solo lectura - Se hace visible)
        # -----------------------------------------------------------------
